...
def report(instance, filename, commodities=None, sites=None):
    ...
    with pd.ExcelWriter(filename) as writer:
        ...
        energy_sums, timeseries = summarize_timeseries(instance, commodities, sites)
...
def compare_scenarios(comp_filename, scenarios, costs=None, esums=None, load_scenario=None, result_dir=None):
    """ Create comparison report sheet and plots for given costs and esums or alternatively for given scenarios.
    ...
    Args:
        ...
        load_scenario: a boolean indicator (feature toggle) of result's source for scenarios comparison
...
def summarize_timeseries(instance, commodities=None, sites=None):
    """Summarizes the energy sums of different commodities and sites over a timeseries.
    Args:
        instance: a urbs model instance
        commodities: optional list of commodities for which to write timeseries
        sites: optional list of sites for which to write timeseries
    ...
    returns:
        energy_sums: Concatenated sum of created, consumed, stored, imported, exported energies of different sites
        over timeseries.
        timeseries: timeseries in which the energy_sums were calculated.
    """
...
def get_esums_costs(instance, commodities=None, sites=None):
    """ retrieves total costs by type and scenario "costs" and sum of energy produced by scenario "esum"
    ...
    esums = summarize_timeseries(instance, commodities, sites)[0]
    return costs, esums
