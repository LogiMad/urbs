...
x_start = 0.0  # x_start: the domain lower bound of the normalized curve equation.x_start = 0.0 # x_start: the domain lower bound of the normalized curve equation.
